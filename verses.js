...
const loveAffirmations = [
    ...
    "Loving you is one of the easiest and most beautiful choices I’ve ever made.",
    "I hope you never forget how much you mean to me.",
    "You bring a kind of peace into my life that I never knew I needed.",
    "I’ll be here to love you in the good moments and hold you through the difficult ones.",
    "Every day with you gives me another reason to be grateful for love.",
    "You are someone I want beside me for all the little moments and the big ones too.",
    "My love for you grows quietly, deeply, and more every day.",
    "You make even the most ordinary days feel worth remembering.",
    "I never want you to question whether you are loved—you are, completely.",
    "You are one of the best things that has ever happened to my heart.",
    "I love the person you are, and I’ll always be proud to stand beside you.",
    "No matter where life takes us, I want to keep finding my way back to you.",
    "You make my world softer, brighter, and so much more beautiful.",
    "I’ll never get tired of discovering new reasons to love you.",
    "You are the person I want to share my happiness, my dreams, and my life with.",
    "I don’t need a perfect life—I just want a life where I get to love you.",
    "You make me feel understood, accepted, and loved in ways I’ll always cherish.",
    "I promise to never let the familiarity of loving you make me forget how special you are.",
    "You are the kind of love I want to protect, nurture, and hold onto forever.",
    "My favorite part of every day is knowing that you’re in my life.",
    "I love you not only for who you are, but for who I become when I’m with you.",
    "Even after countless days together, I’ll still find reasons to fall for you again.",
    "You deserve to feel loved in every little way, and I’ll always try to show you.",
    "I want our love to be a place where both of us feel safe, seen, and cherished.",
    "You are not just a part of my life—you’ve become a part of my heart.",
    "I’ll keep making space for you in my heart, no matter how much life changes.",
    "There’s something beautiful about knowing I get to love you today and wake up wanting to love you tomorrow.",
    "I’m grateful for every memory we’ve made and every moment we haven’t lived yet.",
    "You are my person, and I hope I never stop making you feel how precious you are to me.",
    "If love is a journey, you’re the person I want to take every step with."
];
